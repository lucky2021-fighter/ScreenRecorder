...
//================================================================================
	...
	protected void showNotification(final int notificationId,
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
			createRecordingNotification(notificationId, channelId);
		}
	}

	@RequiresApi(api = Build.VERSION_CODES.O)
	protected void createRecordingNotification(final int notificationId,
											   @NonNull final String channelId) {
		Log.d(TAG, "createRecordingNotification: ");
