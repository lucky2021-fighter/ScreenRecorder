...
import com.serenegiant.screenrecordingsample.MainActivity3;
...
public class ScreenRecorderService extends BaseService {
	...
	protected PendingIntent contextIntent() {
		...
		return PendingIntent.getActivity(this, 0,
			...
			new Intent(this, MainActivity3.class), flags);
	}
...
//--------------------------------------------------------------------------------
			...
			if (mRecorder == null) {
			    ...
			    if (projection != null) {
					...
					try {
						...
						if (DEBUG) Log.v(TAG, "startRecording:output=" + outputFile.getName());
						if (outputFile != null) {
	...
	private IRecorder createRecorder(
		...
		videoEncoder.setVideoConfig(-1, 30, 1);
